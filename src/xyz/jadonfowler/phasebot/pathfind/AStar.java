package xyz.jadonfowler.phasebot.pathfind;
...
public class AStar {
    ...
    public AStar(Vector3d start, Vector3d end, int range) throws InvalidPathException {
        boolean s = true, e = true;
        if (!(s = this.isLocationWalkable(start)) || !(e = this.isLocationWalkable(end))) { throw new InvalidPathException(
                s, e); }
    ...
    public Vector3d getEndLocation() {
        ...
        for (byte x = -1; x <= 1; x++) {
            for (byte y = -1; y <= 1; y++) {
                for (byte z = -1; z <= 1; z++) {
                    ...
                    Tile t = new Tile((short) (current.getX() + x), (short) (current.getY() + y),
                            (short) (current.getZ() + z), current);
                    ...
                    if (x != 0 && z != 0 && (y == 0 || y == 1)) {
                        ...
                        Tile xOff = new Tile((short) (current.getX() + x), (short) (current.getY() + y),
                                (current.getZ()), current), zOff = new Tile((current.getX()),
    ...
    private boolean isTileWalkable(Tile t) {
        Vector3d l = new Vector3d((sx + t.getX()), (sy + t.getY()), (sz + t.getZ()));
        Block b = l.getBlock();
        int i = b.getTypeId();
        ...
        int d = 0;
        if (i != 10 && i != 11 && i != 51 && i != 59 && i != 65 && i != d && i != 85 && i != 107 && i != 113
                && !canBlockBeWalkedThrough(i)) {
            // make sure the blocks above are air
            /*
             * if (b.getRelative(0, 1, 0).getTypeId() == 107) { // fench gate
             * check, if closed continue Gate g = new Gate(b.getRelative(0, 1,
    ...
    private boolean isLocationWalkable(Vector3d l) {
        Block b = l.getBlock();
        int i = b.getTypeId();
    ...
    private boolean canBlockBeWalkedThrough(int id) {
        return (id == 0 || id == 6 || id == 50 || id == 63 || id == 30 || id == 31 || id == 32 || id == 37 || id == 38
                || id == 39 || id == 40 || id == 55 || id == 66 || id == 75 || id == 76 || id == 78);
    }

    @SuppressWarnings("serial") public class InvalidPathException extends Exception {
